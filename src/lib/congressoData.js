...
export const PALESTRAS_SABADO = [
  ...
  },
  {
    ...
    foto: '/images/palestrantes/fabiola.jpeg',
    fotoAlt: 'Foto de Fabíola Dobrillovich',
    shapeClass: 'speaker-avatar-frame--shape3',
  },
];

export const PALESTRAS_DATA = [...PALESTRAS_SEXTA, ...PALESTRAS_SABADO];

export const OFICINAS_DATA = [
  {
    id: 'patricia-couto',
    ministrante: 'Patrícia Couto',
  ...
  {
    id: 'shirley-elaine',
    ministrante: 'Shirley Maria e Elaine Maria',
    tema: 'Dos acalantos às rodas de verso: a música tradicional da infância embalando os brinquedos de criança.',
    categoria: 'Música & Cultura Popular',
  },
  {
    id: 'cleide-derenzi',
    ministrante: 'Cleide Derenzi',
